...
FOREIGN KEY(MACHINE_NAME) REFERENCES machine_type(MACHINE_NAME));
...
CREATE TABLE peration_with_machine
(OPERATION_ID  INT,
MACHINE_ID INT,
START_TIME  DATETIME,
END_TIME  DATETIME,
...
INSERT INTO `user` (`USER_ID`, `FIRST_NAME`, `LAST_NAME`,`PHONE_NUMBER`,`REGION`,`COUNTRY_NAME`,`PROVINCE`,`STREET_ADDRESS`) VALUES
